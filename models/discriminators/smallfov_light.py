...
class SmallFOVLight(chainer.Chain):

    def __init__(self, n_class=21):
        super(SmallFOVLight, self).__init__(
            ...
            conv2_2=L.Convolution2D(128, 128, 1, stride=1, pad=1),
            conv3_1=L.Convolution2D(128, 256, 3, stride=1, pad=1),
            conv3_2=L.Convolution2D(256, 2, 1, stride=1, pad=1),
        )
